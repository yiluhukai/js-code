...
},{"./vnode.js":"node_modules/snabbdom/build/package/vnode.js","./is.js":"node_modules/snabbdom/build/package/is.js","./htmldomapi.js":"node_modules/snabbdom/build/package/htmldomapi.js"}],"src/05-basic-diff.js":[function(require,module,exports) {
"use strict";
...
var patch = (0, _init.init)([]); // 第一个参数是元素的标签和选择器
// 第二个参数是元素的内容

var vNode = (0, _h.h)('ul', [(0, _h.h)('li', {
  key: 'a'
}, '首页'), (0, _h.h)('li', {
  key: 'b'
}, '电影'), (0, _h.h)('li', {
  key: 'c'
}, '微博')]); // 第一个参数可以是旧的vNode，也可以是真实dom
// 第一个参数是新vNode
// 返回值是的新的vNode

var el = document.querySelector("#app"); // 为下一次更新去使用

var oldVnode = patch(el, vNode); // 继续跟新节点

patch(oldVnode, (0, _h.h)('ul', [(0, _h.h)('li', {
  key: 'a'
}, '首页'), (0, _h.h)('li', {
  key: 'c'
}, '微博'), (0, _h.h)('li', {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/05-basic-diff.js"], null)
//# sourceMappingURL=/05-basic-diff.1455e513.js.map